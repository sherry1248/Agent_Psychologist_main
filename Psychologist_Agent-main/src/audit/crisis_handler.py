...
class CrisisHandler:
    ...
    def _get_relevant_resources(self, crisis_type: str) -> List[CrisisResource]:
        ...
        korean_hotlines = self._resources.get("crisis_hotlines", {}).get("kr", [])
        ...
        # Always include Korean emergency resources when available.
        for hotline in korean_hotlines:
            resources.append(CrisisResource(
                name=hotline.get("name", "Korean Crisis Resource"),
                phone=hotline.get("phone"),
                text=hotline.get("text"),
                website=hotline.get("website"),
                description=hotline.get("description", "")
            ))
    ...
    def _get_default_message(self) -> str:
        ...
        return (
            "109 / 119 / 112: 한국에서는 지금 바로 109(자살예방), 119(응급), 112(경찰)로 연락하세요.\n\n"
                ...
                "kr": [
                    {
                        ...
                        "phone": "109",
                        "description": "24/7 crisis and suicide prevention support in Korea"
                    },
                    {
                        "name": "Emergency Services Korea",
                        "phone": "119",
