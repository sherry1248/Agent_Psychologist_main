...
class AuditLogger:
    ...
    def log_safety_check(
        ...
        matched_pattern_reference = None
        if matched_pattern:
            matched_pattern_reference = f"[redacted:{len(matched_pattern)}]"
        ...
        event = AuditEvent(
            ...
            data={
                ...
                "is_safe": is_safe,
                "matched_pattern": matched_pattern_reference,
                "matched_pattern_present": bool(matched_pattern),
